...
import type { SignInFormValues } from "~/schema/auth";
    ...
    const onSubmit = async (data: SignInFormValues) => {
        try {
            ...
            if (!signInResult?.error) {
                ...
                setError(
                    signInResult.error === "CredentailSignin"
    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <div className="hidden py-[3vh] pr-[3vh] lg:block lg:w-1/2">
                <div className="hidden h-full rounded-3xl bg-linear-to-b from-indigo-100 via-purple-100 to-[#5960d7] lg:block">
